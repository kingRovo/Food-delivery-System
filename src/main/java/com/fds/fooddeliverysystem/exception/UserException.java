...
public class UserException extends RuntimeException{
     ...
     */
    public UserException(final Throwable ex, final String message,final String code, final HttpStatus status) {
        super(message, ex);
        this.status = status;
        this.message = message;
        this.code = null;
    ...
    public UserException(final Throwable ex, final String message) {
        super(message, ex);
